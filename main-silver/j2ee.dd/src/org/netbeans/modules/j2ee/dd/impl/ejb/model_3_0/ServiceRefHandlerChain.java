/**
 *	This generated bean class ServiceRefHandlerChain matches the schema element 'service-ref_handler-chainType'.
...
public class ServiceRefHandlerChain extends org.netbeans.modules.schema2beans.BaseBean
	 implements org.netbeans.modules.j2ee.dd.api.common.ServiceRefHandlerChain
{
	...
	public ServiceRefHandlerChain() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public ServiceRefHandlerChain(int options)
	{
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		for (int _index = 0; _index < sizeHandler(); ++_index) {
			org.netbeans.modules.j2ee.dd.impl.ejb.model_3_0.ServiceRefHandler element = (org.netbeans.modules.j2ee.dd.impl.ejb.model_3_0.ServiceRefHandler) getHandler(_index);
			if (element != null) {
	...
	public String dumpBeanNode(){
		...
		str.append("ServiceRefHandlerChain\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
