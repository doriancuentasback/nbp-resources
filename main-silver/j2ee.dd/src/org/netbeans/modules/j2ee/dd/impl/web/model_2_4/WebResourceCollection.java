            ...
            
{
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		for (int _index = 0; _index < sizeHttpMethod(); ++_index) {
			...
			if (element != null) {
				final java.lang.String[] enumRestrictionHttpMethod = {"GET", "POST", "PUT", "DELETE", "HEAD", "OPTIONS", "TRACE"};
				restrictionFailure = true;
				for (int _index2 = 0; 
					_index2 < enumRestrictionHttpMethod.length; ++_index2) {
					if (enumRestrictionHttpMethod[_index2].equals(element)) {
						restrictionFailure = false;
						break;
					}
				}
				if (restrictionFailure) {
					throw new org.netbeans.modules.schema2beans.ValidateException("element enumeration test", org.netbeans.modules.schema2beans.ValidateException.FailureType.ENUM_RESTRICTION, "httpMethod", this);	// NOI18N
				}
			}
		}
	}
