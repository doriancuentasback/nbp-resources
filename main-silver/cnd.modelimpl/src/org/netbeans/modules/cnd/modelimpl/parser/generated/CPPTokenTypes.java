...
public interface CPPTokenTypes {
	...
	int CSM_START = 510;
	int CSM_TRANSLATION_UNIT = 511;
	int CSM_CLASS_DECLARATION = 512;
	int CSM_ENUM_DECLARATION = 513;
	int CSM_ENUM_FWD_DECLARATION = 514;
	int CSM_NAMESPACE_DECLARATION = 515;
	int CSM_CTOR_DECLARATION = 516;
	int CSM_CTOR_TEMPLATE_DECLARATION = 517;
	int CSM_FUNCTION_DECLARATION = 518;
	int CSM_FUNCTION_LIKE_VARIABLE_DECLARATION = 519;
	int CSM_FUNCTION_DEFINITION = 520;
	int CSM_FUNCTION_RET_FUN_DECLARATION = 521;
	int CSM_FUNCTION_RET_FUN_DEFINITION = 522;
	int CSM_FUNCTION_TEMPLATE_DECLARATION = 523;
	int CSM_FUNCTION_TEMPLATE_DEFINITION = 524;
	int CSM_PARAMETER_DECLARATION = 525;
	int CSM_TYPE_BUILTIN = 526;
	int CSM_TYPE_DECLTYPE = 527;
	int CSM_TYPE_COMPOUND = 528;
	int CSM_TEMPLATE_EXPLICIT_SPECIALIZATION = 529;
	int CSM_FWD_TEMPLATE_EXPLICIT_SPECIALIZATION = 530;
	int CSM_TEMPLATE_EXPLICIT_INSTANTIATION = 531;
	int CSM_TEMPLATE_CTOR_DEFINITION_EXPLICIT_SPECIALIZATION = 532;
	int CSM_TEMPLATE_DTOR_DEFINITION_EXPLICIT_SPECIALIZATION = 533;
	int CSM_TEMPLATE_FUNCTION_DEFINITION_EXPLICIT_SPECIALIZATION = 534;
	int CSM_USER_TYPE_CAST_DEFINITION_EXPLICIT_SPECIALIZATION = 535;
	int CSM_TEMPLATE_CLASS_DECLARATION = 536;
	int CSM_EXTERN_TEMPLATE = 537;
	int CSM_TEMPLATE_TEMPLATE_PARAMETER = 538;
	int CSM_DTOR_DEFINITION = 539;
	int CSM_DTOR_TEMPLATE_DEFINITION = 540;
	int CSM_DTOR_DECLARATION = 541;
	int CSM_CTOR_DEFINITION = 542;
	int CSM_CTOR_TEMPLATE_DEFINITION = 543;
	int CSM_USER_TYPE_CAST_DECLARATION = 544;
	int CSM_USER_TYPE_CAST_TEMPLATE_DECLARATION = 545;
	int CSM_USER_TYPE_CAST_DEFINITION = 546;
	int CSM_USER_TYPE_CAST_TEMPLATE_DEFINITION = 547;
	int CSM_GENERIC_DECLARATION = 548;
	int CSM_TEMPL_FWD_CL_OR_STAT_MEM = 549;
	int CSM_STRANGE_2 = 550;
	int CSM_FIELD = 551;
	int CSM_VISIBILITY_REDEF = 552;
	int CSM_TEMPLATE_PARMLIST = 553;
	int CSM_PARMLIST = 554;
	int CSM_KR_PARMLIST = 555;
	int CSM_ENUMERATOR_LIST = 556;
	int CSM_NAMESPACE_ALIAS = 557;
	int CSM_USING_DIRECTIVE = 558;
	int CSM_USING_DECLARATION = 559;
	int CSM_TYPE_ALIAS = 560;
	int CSM_CTOR_INITIALIZER = 561;
	int CSM_CTOR_INITIALIZER_LIST = 562;
	int CSM_QUALIFIED_ID = 563;
	int CSM_STATEMENTS_START = 564;
	int CSM_LABELED_STATEMENT = 565;
	int CSM_CASE_STATEMENT = 566;
	int CSM_DEFAULT_STATEMENT = 567;
	int CSM_EXPRESSION_STATEMENT = 568;
	int CSM_DECLARATION_STATEMENT = 569;
	int CSM_COMPOUND_STATEMENT = 570;
	int CSM_COMPOUND_STATEMENT_LAZY = 571;
	int CSM_TRY_CATCH_STATEMENT_LAZY = 572;
	int CSM_IF_STATEMENT = 573;
	int CSM_SWITCH_STATEMENT = 574;
	int CSM_WHILE_STATEMENT = 575;
	int CSM_DO_WHILE_STATEMENT = 576;
	int CSM_FOR_STATEMENT = 577;
	int CSM_GOTO_STATEMENT = 578;
	int CSM_CONTINUE_STATEMENT = 579;
	int CSM_BREAK_STATEMENT = 580;
	int CSM_RETURN_STATEMENT = 581;
	int CSM_TRY_STATEMENT = 582;
	int CSM_CATCH_CLAUSE = 583;
	int CSM_THROW_STATEMENT = 584;
	int CSM_ASM_BLOCK = 585;
	int CSM_STATEMENTS_END = 586;
	int CSM_EXPRESSIONS_START = 587;
	int CSM_EXPRESSION = 588;
	int CSM_CAST_EXPRESSION = 589;
	int CSM_FUN_TYPE_CAST_EXPRESSION = 590;
	int CSM_FUNCALL_EXPRESSION = 591;
	int CSM_EXPRESSIONS_END = 592;
	int CSM_FOR_INIT_STATEMENT = 593;
	int CSM_LINKAGE_SPECIFICATION = 594;
	int CSM_PTR_OPERATOR = 595;
	int CSM_ARRAY_DECLARATION = 596;
	int CSM_VARIABLE_DECLARATION = 597;
	int CSM_VARIABLE_LIKE_FUNCTION_DECLARATION = 598;
	int CSM_CONDITION = 599;
	int CSM_BASE_SPECIFIER = 600;
	int CSM_TEST = 601;
	int CSM_END = 602;
}
