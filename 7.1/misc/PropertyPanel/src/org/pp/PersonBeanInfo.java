...
public class PersonBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( org.pp.Person.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor

        // Here you can add code for customizing the BeanDescriptor.

        return beanDescriptor;     }//GEN-LAST:BeanDescriptor
    // Property identifiers//GEN-FIRST:Properties
    private static final int PROPERTY_city = 0;
    private static final int PROPERTY_courses = 1;
    private static final int PROPERTY_name = 2;
    private static final int PROPERTY_photo = 3;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_city] = new PropertyDescriptor ( "city", org.pp.Person.class, "getCity", "setCity" ); // NOI18N
            properties[PROPERTY_courses] = new PropertyDescriptor ( "courses", org.pp.Person.class, "getCourses", "setCourses" ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", org.pp.Person.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_photo] = new PropertyDescriptor ( "photo", org.pp.Person.class, "getPhoto", "setPhoto" ); // NOI18N
        }
