...
public class CustomerSample1PanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private CustomerSample1WizardPanel panel;

    public CustomerSample1PanelVisual(CustomerSample1WizardPanel panel) {
        initComponents();
        this.panel = panel;
