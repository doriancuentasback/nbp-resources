...
public class CustomerSample3PanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private CustomerSample3WizardPanel panel;

    public CustomerSample3PanelVisual(CustomerSample3WizardPanel panel) {
        initComponents();
        this.panel = panel;
