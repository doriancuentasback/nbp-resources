...
@Messages("MySampleApplication_displayName=My Sample Application")
public class MySampleApplicationWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {

    private int index;
    private WizardDescriptor.Panel[] panels;
    private WizardDescriptor wiz;

    public MySampleApplicationWizardIterator() {
    }

    public static MySampleApplicationWizardIterator createIterator() {
        return new MySampleApplicationWizardIterator();
    }
