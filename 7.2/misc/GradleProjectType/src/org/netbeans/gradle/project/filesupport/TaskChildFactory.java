...
class TaskChildFactory extends ChildFactory<Task> implements FileChangeListener {
    ...
    @StaticResource()
    public static final String TASK_IMAGE = "org/netbeans/gradle/project/resources/task.gif";
...
//            list.add(externalDependency.getFile());
//        }
                ...
                return new AbstractAction() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            GradleConnector gradleConnector = GradleConnector.newConnector();
                            gradleConnector.forProjectDirectory(FileUtil.toFile(dobj.getPrimaryFile().getParent()));
                            //String gradleLoc = NbPreferences.forModule(GradlePanel.class).get("gradleLoc", "/home/geertjan/Downloads/gradle-1.0-milestone-7");
...
//                                    StatusDisplayer.getDefault().setStatusText(key.getName() + " completed",1);
//                                }
//                                @Override
//                                public void onFailure(GradleConnectionException gce) {
//                                    StatusDisplayer.getDefault().setStatusText(key.getName() + " failed",1);
//                                }
//                            });
        ...
        taskNode.setIconBaseWithExtension(TASK_IMAGE);
        return taskNode;
    }
