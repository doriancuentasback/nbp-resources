...
public class PersistenceClientSetupPanelVisual extends javax.swing.JPanel implements DocumentListener, CancellableDialog {
    ...
    public static final String VIEW_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/view.ftl"; // NOI18N
    public static final String LIST_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/list.ftl"; // NOI18N
    public static final String CREATE_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/create.ftl"; // NOI18N
    public static final String EDIT_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/edit.ftl"; // NOI18N
    public static final String CONTROLLER_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/controller.ftl"; // NOI18N
    public static final String PAGINATION_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/PaginationHelper.ftl"; // NOI18N
    public static final String UTIL_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/JsfUtil.ftl"; // NOI18N
    public static final String BUNDLE_TEMPLATE = "/Templates/MyJSF/JSF_From_Entity_Wizard/bundle.ftl"; // NOI18N
...
//        wizard.putProperty(WizardDescriptor.PROP_ERROR_MESSAGE, null); // NOI18N
            ...
            if (overrideExistingCheckBox.isVisible()) {
                boolean conflict = MyPersistenceClientIterator.doesSomeFileExistAlready(
...
//        changeSupport.fireChange();
    ...
    void read(WizardDescriptor settings) {
        ...
        boolean jsf2Generator = "true".equals(settings.getProperty(MyPersistenceClientIterator.JSF2_GENERATOR_PROPERTY));
