...
public class MovieBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.mit.movie.domain.Movie.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor

        // Here you can add code for customizing the BeanDescriptor.

        return beanDescriptor;     }//GEN-LAST:BeanDescriptor
    // Property identifiers//GEN-FIRST:Properties
    private static final int PROPERTY_movieTorrent = 0;
    private static final int PROPERTY_themeColor = 1;
    private static final int PROPERTY_title = 2;
    private static final int PROPERTY_year = 3;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_movieTorrent] = new PropertyDescriptor ( "movieTorrent", com.mit.movie.domain.Movie.class, "getMovieTorrent", "setMovieTorrent" ); // NOI18N
            properties[PROPERTY_movieTorrent].setDisplayName ( "Torrent" );
            properties[PROPERTY_themeColor] = new PropertyDescriptor ( "themeColor", com.mit.movie.domain.Movie.class, "getThemeColor", "setThemeColor" ); // NOI18N
            properties[PROPERTY_themeColor].setDisplayName ( "Theme Color" );
            properties[PROPERTY_title] = new PropertyDescriptor ( "title", com.mit.movie.domain.Movie.class, "getTitle", "setTitle" ); // NOI18N
            properties[PROPERTY_title].setDisplayName ( "Movie Title" );
            properties[PROPERTY_year] = new PropertyDescriptor ( "year", com.mit.movie.domain.Movie.class, "getYear", "setYear" ); // NOI18N
            properties[PROPERTY_year].setDisplayName ( "Release Year" );
        }
