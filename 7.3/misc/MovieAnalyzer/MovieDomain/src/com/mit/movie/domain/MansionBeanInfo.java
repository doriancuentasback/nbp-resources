 ...
 * @author Geertjan
 */
public class MansionBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.mit.movie.domain.Mansion.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_city] = new PropertyDescriptor ( "city", com.mit.movie.domain.Mansion.class, "getCity", "setCity" ); // NOI18N
            properties[PROPERTY_city].setDisplayName ( "City" );
        }
