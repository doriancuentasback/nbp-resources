 ...
 * @author Geertjan
 */
public class ActorBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.mit.movie.domain.Actor.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor

        // Here you can add code for customizing the BeanDescriptor.

        return beanDescriptor;     }//GEN-LAST:BeanDescriptor
    // Property identifiers//GEN-FIRST:Properties
    private static final int PROPERTY_nsme = 0;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_nsme] = new PropertyDescriptor ( "nsme", com.mit.movie.domain.Actor.class, "getNsme", "setNsme" ); // NOI18N
            properties[PROPERTY_nsme].setDisplayName ( "Name" );
        }
