...
/**
 * Classe utilis�e pour l'analyse des self assignment sur les fields dans les m�thodes.
 * <br/>Algorithme tir� du guide ASM p100 pour les fields.
 * @author evernat
 */
class SelfAssignmentAnalyzer { // NOPMD
	...
	Set<String> analyze() { // NOPMD
		// la complexit� de cette m�thode est ignor�e
		// car c'est un exemple tir� presque tel quel du guide d'asm
			...
			if (isALOAD0(i1)) {
				...
				if (i2 != null && isALOAD0(i2)) {
					...
					while (i3 != null && isALOAD0(i3)) {
						// non n�cessaire : i1 = i2;
						// non n�cessaire : i2 = i3;
						i3 = getNext(it);
					}
