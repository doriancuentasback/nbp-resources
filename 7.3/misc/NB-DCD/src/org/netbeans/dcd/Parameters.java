...
/**
 * Objet portant tous les param�tres d�finis par l'IHM ou par un fichier de configuration
 * (ou bien dans les pr�f�rences utilisateur pour les valeurs par d�faut sans fichier de configuration).
 * @author evernat
 */
public class Parameters {
	/**
	 * Cl� du param�tre "directories".
	 */
	...
	/**
	 * Constructeur.
	 * xmlReportFile n'est pas un param�tre du constructeur (reste null par d�faut),
	 * mais il y a une m�thode setXmlReportFile.
	 * @param directories R�pertoires (ou fichiers jar, wars) � analyser
	 * @param publicDeadCode Si d�tection du code mort public et protected
	 * @param privateDeadCode Si d�tection du code mort package-private et private
	 * @param localDeadCode Si d�tection du code mort des variables locales
	 * @param initDeadCode Si d�tection des initialisations inutiles
	 * @param excludedClasses Expressions r�guli�res de classes (ou packages) � ne pas auditer (ex : mypackage.*)
	 * @param excludedMethods Expressions r�guli�res de m�thodes ou attributs � ne pas auditer (ex : get.*)
	 */
	...
	/**
	 * Charge les param�tres depuis les propri�t�s syst�mes (-Dproperty=value).
	 * @return Parameters
	 */
	...
	/**
	 * Charge les param�tres depuis un fichier de configuration au format properties.
	...
	/**
	 * Charge les param�tres depuis les pr�f�rences utilisateur.
	 * @return Parameters
	...
	/**
	 * Ecrit les param�tres dans les pr�f�rences utilisateurs.
	 * @throws BackingStoreException e
	 */
	...
	/**
	 * @return R�pertoires (ou fichiers jar, wars) � analyser.
	 */
	...
	/**
	 * @return Expressions r�guli�res de classes (ou packages) � ne pas auditer (ex : mypackage.*)
	 */
	...
	/**
	 * @return Expressions r�guli�res de m�thodes ou attributs � ne pas auditer (ex : get.*)
	 */
	...
	/**
	 * @return Bool�en selon que le code mort public doit �tre d�tect�
	 */
	...
	/**
	 * @return Bool�en selon que le code mort private doit �tre d�tect�
	 */
	...
	/**
	 * @return Bool�en selon que le code mort des variables locales doit �tre d�tect�
	 */
	...
	/**
	 * @return Bool�en selon que les initialisations inutiles doivent �tre d�tect�es
	 */
	...
	boolean isClassExcluded(String className) {
		for (final Pattern pattern : getExcludedClasses()) {
			if (pattern.matcher(className).matches()) {
				// cette classe est exclue des classes audit�es
				return true;
			}
		}
		return false;
	...
	boolean isMethodExcluded(String method) {
		for (final Pattern pattern : getExcludedMethods()) {
			if (pattern.matcher(method).matches()) {
				// cette m�thode (ou cet attribut) est exclue des m�thodes audit�es
				return true;
			}
		}
		return false;
