...
/**
 * Affichage et export xml des r�sultats d'analyses.
 * @author evernat
 */
class Report {
	private static final String XML_INDENT = "  ";
	// retour � la ligne xml normalis� (http://www.w3.org/TR/xml11/#sec-line-ends)
	...
	private void reportWarning(String type, String className, String msg, String msg2)
		...
		if (xmlStreamWriter == null) {
			...
			xmlStreamWriter.writeEndElement();
			xmlStreamWriter.writeCharacters(XML_END_OF_LINE); // retour � la ligne pour lisibilit�
		}
	}
