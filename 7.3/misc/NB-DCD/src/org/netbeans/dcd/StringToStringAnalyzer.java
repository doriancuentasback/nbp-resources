...
/**
 * Classe utilis�e pour l'analyse des appels de toString() sur des String dans les m�thodes.
 * @author evernat
 */
		...
		for (final Iterator<AbstractInsnNode> it = methodNode.instructions.iterator(); it.hasNext();) {
			...
			if (instruction instanceof MethodInsnNode) {
				...
				if (STRING_INTERNAL_NAME.equals(methodInsnNode.owner)
					...
					// il n'y a qu'une m�thode toString dans la classe String, inutile de v�rifier desc
					return true;
				}
			}
		}
