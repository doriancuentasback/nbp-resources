...
/**
 * Classe h�ritant de JTable et affichant des tooltips pour les cellules.
 * Les classes filles d�finiront les impl�mentations particuli�res.
 * @author evernat
 */
class Table extends JTable {
	...
	public java.awt.Component prepareRenderer(TableCellRenderer renderer, int rowIndex,
			int vColIndex) {
		// Surcharge pour la gestion des lignes de couleurs altern�es.
	...
	/**
	 * Renvoie le texte � la position demand�e.
	 * @return String
	 * @param row int
	 * @param column int
	 */
