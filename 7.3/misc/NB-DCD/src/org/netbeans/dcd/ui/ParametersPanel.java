...
/**
 * Vue principale en JPanel Swing pour l'IHM (design pattern Mod�le-Vue-Contr�leur).
 * Le mod�le est la classe Parameters dans le package dcd.
 * @author evernat
 */
class ParametersPanel extends JPanel {
	...
	private JPanel getCenterPanel() {
		...
		// scrollbar vertical � always pour �viter d'avoir la scrollbar horizontal
