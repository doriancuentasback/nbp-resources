...
public class HTMLAttributeCompletionItem implements CompletionItem {
    ...
    private String text;
    private HTMLAttribute langAttribute;

    public HTMLAttributeCompletionItem(Map map, HTMLAttribute langAttribute,String text) {
        this.text = text;
        this.langAttribute = langAttribute;
        ICON =
            new ImageIcon(ImageUtilities.loadImage(map.get("iconBase").toString()));
    }
